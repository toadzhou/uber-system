...
import com.roncoo.recharge.web.service.MobileInfoService;
...
import com.roncoo.recharge.web.bean.qo.MobileInfoQO;
...
public class MobileInfoController extends BaseController {
	...
	public void list(@RequestParam(value = "pageCurrent", defaultValue = "1") int pageCurrent, @RequestParam(value = "pageSize", defaultValue = "20") int pageSize, @ModelAttribute MobileInfoQO qo, ModelMap modelMap){
