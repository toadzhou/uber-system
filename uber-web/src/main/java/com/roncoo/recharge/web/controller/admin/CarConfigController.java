...
public class CarConfigController extends BaseController {
	...
	@Autowired
	private CarConfigService service;
	
	@RequestMapping(value = "/list")
	public void list(@RequestParam(value = "pageCurrent", defaultValue = "1") int pageCurrent, @RequestParam(value = "pageSize", defaultValue = "20") int pageSize, @ModelAttribute CarConfigQO qo, ModelMap modelMap){
	...
	public String save(@ModelAttribute CarConfigQO qo){
	...
	public String update(@ModelAttribute CarConfigQO qo){
