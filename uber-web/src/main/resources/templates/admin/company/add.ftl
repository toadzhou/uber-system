...
<div class="pageContent">
	<form action="${base}/admin/company/save" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
        <div class="pageFormContent" layoutH="58">
    		<p>
                <label>负责人姓名：</label>
                <input type="text" name="ownerName" value="" placeholder="负责人姓名" size="20" />
            </p>
    		<p>
                <label>创建人：</label>
