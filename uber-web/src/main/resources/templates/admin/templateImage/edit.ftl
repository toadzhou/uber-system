...
<div class="pageContent">
	<form action="${base}/admin/templateImage/update" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="58">
            <input type="hidden" name="id" value="${bean.id}"/>
    		<p>
                <label>所属模版Id：</label>
                <input type="text" name="templateId" value="${bean.templateId}" placeholder="所属模版Id" size="20" />
            </p>
    		<p>
                <label>图片Id：</label>
                <input type="text" name="imageId" value="${bean.imageId}" placeholder="图片Id" size="20" />
            </p>
    		<p>
                <label>创建人：</label>
