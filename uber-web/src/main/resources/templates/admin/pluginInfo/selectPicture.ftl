...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="${base}/admin/pluginInfo/selectPicture" method="post">
        <@pageHeadr />
        <br>
        <input type="hidden" name="pluginInfoId" value="${pluginInfoId!}"/>
        <div class="bjui-searchBar">
            ...
            <br />
            <br />
<#--            <a href="${base}/admin/pictureUnit/add" class="btn btn-default" data-toggle="dialog" data-icon="plus" data-id="admin-pluginInfo" data-options="{title:'添加', height:350}">新增图片</a>-->
        </div>
    </form>
</div>
